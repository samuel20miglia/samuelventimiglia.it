...
class AboutAction
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, callable $next)
    {
        ...
        $model->setTemplate('layout/pages')->pageHeader = 'About';
        $model->setTemplate('layout/pages')->pageContainer = 'about';
        $model->setTemplate('layout/pages')->headTitle = 'About - samuelventimglia.it';
